...
{
	// UnityEngine.Vector3 RepeatBackground::startPosition
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerControllerX_Update_mE690DFA5B4D44A839AC48EC903E382790B5CCC8B (PlayerControllerX_tF9D775557FE097FA08B4768B1295EA527AFF0D2B* __this, const RuntimeMethod* method) 
{
	...
	{
		// isLowEnough = false;
		__this->___isLowEnough_6 = (bool)0;
		goto IL_0027;
	}
...
IL_0020:
	{
		// isLowEnough = true;
		__this->___isLowEnough_6 = (bool)1;
	}
...
IL_0027:
	...
	{
		bool L_4 = __this->___isLowEnough_6;
		if (!L_4)
		{
			goto IL_005b;
		}
...
IL_008f:
	...
	}
	{
		...
		AudioSource_t871AC2272F896738252F04EE949AEF5B241D3299* L_20 = __this->___playerAudio_11;
		AudioClip_t5D272C4EB4F2D3ED49F1C346DEA373CF6D585F20* L_21 = __this->___bounceSound_14;
		AudioSource_PlayOneShot_mF6FE95C58996B38EF6E7F7482F95F5E15E0AB30B(L_20, L_21, (1.5f), NULL);
	}
...
{
	{
		...
		L_1 = Transform_get_position_m69CD5FA214FDAE7BB701552943674846C220FDE1(L_0, NULL);
		float L_2 = L_1.___x_2;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_3 = (&__this->___startPosition_4);
		float L_4 = L_3->___x_2;
		float L_5 = __this->___repeatWidth_5;
		if ((!(((float)L_2) < ((float)((float)il2cpp_codegen_subtract(L_4, L_5))))))
		{
	...
	}
	{
		...
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_6;
		L_6 = Component_get_transform_m2919A1D81931E6932C7F06D4C2F0AB8DDA9A5371(__this, NULL);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_7 = __this->___startPosition_4;
		Transform_set_position_mA1A817124BB41B685043DED2A9BA48CDF37C4156(L_6, L_7, NULL);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SpawnManager_SpawnObstacle_mE5D7865D1E72DF72FAB39ACE07DA8AF8E81B4F42 (SpawnManager_tD38605BF221D4CC849CF709A85499D2B698FD6FC* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_3 = __this->___spawnPosition_5;
